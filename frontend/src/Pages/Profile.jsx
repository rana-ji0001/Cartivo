...
const Profile = () => {
    ...
    const badgeStyle = { background: 'rgba(249,115,22,0.1)', color: '#e6e6e6', padding: '6px 12px', borderRadius: '8px', fontSize: '0.9rem', fontWeight: 'bold', display: 'inline-block' };
        ...
        <div style={containerStyle}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '30px', marginBottom: '30px' }}>
                <div>
                    ...
                    <p style={{ color: '#a1a1aa', fontSize: '1.2rem', marginBottom: '5px' }}><strong>Name:</strong> {user.username}</p>
                ...
                <button onClick={handleLogout} className="shine-btn btn" style={{ background: '#404e3b', boxShadow: 'none' }}>Logout</button>
            </div>

            <h3 style={{ color: '#93b387', marginBottom: '20px', fontSize: '1.5rem' }}>Order History</h3>
            {loading ? (
